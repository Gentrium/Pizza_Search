...
public class FoursquareVenuesNearbyRequest extends
    ...
    protected void onPreExecute() {
        ...
        mProgress.show();
        dataSave =  mActivity.getSharedPreferences(FoursquareConstants.SHARED_PREF_FILE, Context.MODE_PRIVATE);
        super.onPreExecute();
    }
    ...
    protected ArrayList<Venue> doInBackground(String... params) {
        ...
        try {
            ...
            if (returnCode == 200) {
                ...
                editor.putString(FoursquareConstants.RESPONSE_JSON, venuesJson.toString());
                editor.apply();
                Gson gson = new Gson();
